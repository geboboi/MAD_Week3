...
struct ProductDetailView: View {
    ...
    var body: some View {
        ...
        NavigationLink("View Specifications", destination: ProductSpecificationView(product: product))
            .padding()
            .background(RoundedRectangle(cornerRadius: 12).fill(product.color.opacity(0.2)))
            .foregroundColor(product.color)
    }
}
